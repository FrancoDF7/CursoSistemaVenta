...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        private void frmClientes_Load(object sender, EventArgs e)
        {
            ...
            //mediante el metodo listar de clase CN_Cliente.
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            //de lo contrario signific que se esta editando un Cliente existente.
            if (obj.IdCliente == 0)
            {
                int idgenerado = new CN_Cliente().Registrar(obj, out mensaje);

                //Si el idClientegenerado es distinto de 0 significa que se registro correctamente el Cliente
                if (idgenerado != 0)
                {
                    //Carga datagridview con los datos del nuevo Cliente, el primer valor lleva "" ya que no posee un valor como tal porque es un botón
            ...
            else
            {
                ...
                //Actualiza el dgvdata la fila que corresponda con los nuevos valores del Cliente que se edito
                if (resultado == true)
                {
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    //Muestra en el combobox cboestado el estado que le corresponda al Cliente que se selecciono
                    foreach (OpcionCombo oc in cboestado.Items)
                    {
                        //Valida que valor del combo sea el mismo que el de estado del Cliente
        ...
        {
            //Valida que se selecciono un Cliente del dgvdata
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                //Si se hace click en boton de SI procede a eliminar el Cliente
                if (MessageBox.Show("¿Desea eliminar el cliente?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (respuesta == true)
                    {
                        //Elimina la fila que le correspondia al Cliente eliminado
        ...
        private void btnexportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteClientes_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss")); //Nombre del archivo excel junto con su fecha de creacion
